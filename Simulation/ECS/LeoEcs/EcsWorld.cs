...
namespace Leopotam.Ecs {
    ...
    public class EcsWorld : IDisposable {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EcsEntity CreateEntityWith<T1, T2, T3, T4>(out T1 c1, out T2 c2, out T3 c3, out T4 c4) where T1 : class, new() where T2 : class, new() where T3 : class, new() where T4 : class, new()
        {
#if DEBUG
            if (typeof(T1) == typeof(T2)) { throw new Exception(string.Format("Cant create entity with multiple components of same type \"{0}\"", typeof(T1).Name)); }
            if (typeof(T1) == typeof(T3) || typeof(T2) == typeof(T3)) { throw new Exception(string.Format("Cant create entity with multiple components of same type \"{0}\"", typeof(T3).Name)); }
            ...
            c2 = AddComponent<T2>(entity);
            c3 = AddComponent<T3>(entity);
            c4 = AddComponent<T4>(entity);
            return entity;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EcsEntity CreateEntityWith<T1, T2, T3, T4, T5>(out T1 c1, out T2 c2, out T3 c3, out T4 c4, out T5 c5) where T1 : class, new() where T2 : class, new() where T3 : class, new() where T4 : class, new() where T5 : class, new()
        {
#if DEBUG
            if (typeof(T1) == typeof(T2)) { throw new Exception(string.Format("Cant create entity with multiple components of same type \"{0}\"", typeof(T1).Name)); }
            if (typeof(T1) == typeof(T3) || typeof(T2) == typeof(T3)) { throw new Exception(string.Format("Cant create entity with multiple components of same type \"{0}\"", typeof(T3).Name)); }
            ...
            c3 = AddComponent<T3>(entity);
            c4 = AddComponent<T4>(entity);
            c5 = AddComponent<T5>(entity);
            return entity;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EcsEntity CreateEntityWith<T1, T2, T3, T4, T5, T6>(out T1 c1, out T2 c2, out T3 c3, out T4 c4, out T5 c5, out T6 c6) where T1 : class, new() where T2 : class, new() where T3 : class, new() where T4 : class, new() where T5 : class, new() where T6 : class, new()
        {
#if DEBUG
            if (typeof(T1) == typeof(T2)) { throw new Exception(string.Format("Cant create entity with multiple components of same type \"{0}\"", typeof(T1).Name)); }
            if (typeof(T1) == typeof(T3) || typeof(T2) == typeof(T3)) { throw new Exception(string.Format("Cant create entity with multiple components of same type \"{0}\"", typeof(T3).Name)); }
            ...
            c4 = AddComponent<T4>(entity);
            c5 = AddComponent<T5>(entity);
            c6 = AddComponent<T6>(entity);
            return entity;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EcsEntity CreateEntityWith<T1, T2, T3, T4, T5, T6, T7>(out T1 c1, out T2 c2, out T3 c3, out T4 c4, out T5 c5, out T6 c6, out T7 c7) where T1 : class, new() where T2 : class, new() where T3 : class, new() where T4 : class, new() where T5 : class, new() where T6 : class, new() where T7 : class, new()
        {
#if DEBUG
            if (typeof(T1) == typeof(T2)) { throw new Exception(string.Format("Cant create entity with multiple components of same type \"{0}\"", typeof(T1).Name)); }
            if (typeof(T1) == typeof(T3) || typeof(T2) == typeof(T3)) { throw new Exception(string.Format("Cant create entity with multiple components of same type \"{0}\"", typeof(T3).Name)); }
